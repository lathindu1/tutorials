...
class MetamaskValidatorCommand extends Command
{
    ...
    {
        $master_account = "Your Master Account Address Here."; //please paste your master Metamask account address here
    ...
    {
        $api_key = "Your APi Key Here"; // pase your api key here. which was copied from Etherscan.io
